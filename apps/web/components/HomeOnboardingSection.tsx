  ...
  return (
    <section id="features" className="scroll-mt-24 px-4 py-16 sm:px-6 sm:py-24 lg:py-32">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <h2 className="mt-5 text-[1.85rem] font-medium leading-[1.15] tracking-[-0.02em] text-white sm:text-[2.75rem] sm:leading-[1.1] sm:tracking-[-0.03em]">
          A secure identity layer for every student.
        </h2>
        <p className="mx-auto mt-5 max-w-[34rem] text-[0.95rem] leading-[1.75] text-slate-400 sm:mt-6 sm:text-[1.1rem]">
      ...
      <div className="mx-auto mt-16 grid max-w-5xl grid-cols-1 gap-5 sm:mt-24 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-3 lg:gap-6 md:max-w-3xl lg:max-w-5xl">
        {benefits.map((benefit, index) => (
          <article
            key={benefit.title}
            className="group relative flex flex-col justify-between overflow-hidden rounded-[2rem] border border-white/[0.03] bg-white/[0.01] p-6 transition-all duration-700 ease-out hover:border-white/[0.06] hover:bg-white/[0.02] hover:shadow-[0_24px_48px_-12px_rgba(0,0,0,0.4)] sm:p-8 md:p-10 md:flex-row md:items-center md:gap-8 lg:flex-col lg:items-start lg:gap-0"
          >
            ...
            <div className="relative z-10 flex w-full flex-col md:flex-row md:items-center md:gap-10 lg:flex-col lg:items-start lg:gap-0">
              <div className="mb-10 flex items-start justify-between md:mb-0 md:flex-col md:gap-5 lg:mb-12 lg:flex-row lg:justify-between shrink-0">
              ...
              <li key={step.title} className="relative group">
                ...
                <div className="flex flex-row gap-6 md:gap-10 lg:flex-col lg:items-center lg:text-center lg:gap-0">
                  ...
                  <div className="flex flex-col items-center lg:mb-12 lg:justify-center">
                    <div className="relative z-10 flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-white/10 bg-[#0b1422] transition-all duration-700 ease-out group-hover:border-white/30 group-hover:bg-[#131f33] group-hover:shadow-[0_0_20px_rgba(255,255,255,0.05)] md:h-[3.25rem] md:w-[3.25rem] lg:h-11 lg:w-11">
                      <span className="text-[0.75rem] font-medium tracking-[0.05em] text-slate-400 transition-colors duration-500 group-hover:text-slate-100">
                        0{index + 1}
                      </span>
                    </div>
                  </div>
