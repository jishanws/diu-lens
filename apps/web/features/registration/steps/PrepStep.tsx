  ...
  return (
    <div className="space-y-5">
      <header className="space-y-2">
        ...
        <p className="landing-text-secondary leading-6">
          Before continuing, make sure your environment is ready for a quick and
          accurate face verification scan.
        </p>
      </header>

      <div className="border border-blue-100/80 bg-blue-50/70 p-3.5 dark:border-white/10 dark:bg-[#0b1220]">
        <p className="mb-2 inline-flex items-center gap-2 font-semibold text-blue-900 dark:text-slate-300">
