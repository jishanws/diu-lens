...
export type CaptureDebugState = {
  ...
  faceModelStatus: 'loading' | 'ready' | 'failed';
  faceModelError: string | null;
  wasmPath: string;
  modelPath: string;
  lastDetectionAt: number | null;
  facesDetectedCount: number | null;
  rawDetectionConfidence: number | null;
  rawResultKeys: string[] | null;
  faceLandmarksCount: number | null;
  faceBlendshapesCount: number | null;
  facialTransformationMatrixesCount: number | null;
  yaw: number | null;
  rawYaw: number | null;
  ...
  faceDetected: boolean;
  faceBox: string;
  faceBoxX: number | null;
  faceBoxY: number | null;
  faceBoxWidth: number | null;
  faceBoxHeight: number | null;
  faceCenterOffsetX: number | null;
  faceCenterOffsetY: number | null;
  faceCenterOffset: number | null;
  faceSizeRatio: number | null;
  maxAllowedCenterOffset: number;
  minAllowedFaceSizeRatio: number;
  ...
  requiredSamplesPerAngle: number;
  stableMs: number;
