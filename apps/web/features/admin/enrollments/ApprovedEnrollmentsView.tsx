          ...
          {!error && rows.length > 0 ? (
            <div className="flex flex-col gap-3">
              {rows.map((item) => {
                ...
                return (
                  <div key={item.student_id} className="group relative flex flex-col gap-4 sm:gap-5 rounded-[1.25rem] border border-white/[0.03] bg-white/[0.01] p-4 sm:p-5 transition-all hover:bg-white/[0.02] sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-col gap-1 sm:w-1/3">
                      <div className="text-[0.7rem] uppercase tracking-widest text-slate-500 font-medium mb-1">Approved On</div>
                    ...
                    {/* Actions */}
                    <div className="flex shrink-0 flex-wrap items-center gap-3 sm:w-1/4 sm:justify-end">
                      {isSuperAdmin ? (
                        <button
                          type="button"
                          className="admin-btn-ghost w-full sm:w-auto justify-center !text-slate-400 hover:!text-rose-400 hover:!bg-rose-500/10 hover:!border-rose-500/20 border border-transparent"
