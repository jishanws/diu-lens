        ...
        {studentId && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 right-0 z-50 w-full sm:w-[90vw] max-w-5xl border-l border-slate-800 bg-[#03060c] shadow-2xl flex flex-col pt-[env(safe-area-inset-top)]"
            >
              {/* Header */}
              <div className="flex items-center justify-between border-b border-white/[0.04] bg-[#03060c]/80 backdrop-blur-md p-4 sm:p-6 sticky top-0 z-10 min-h-[64px]">
                <div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="rounded-2xl bg-black/20 p-3 sm:p-4 border border-white/[0.03]">
                          ...
                          <div className="flex items-end gap-2">
                            <span className="text-xl sm:text-2xl font-semibold text-cyan-400">
                    ...
                    <div className="order-3 lg:order-none lg:col-start-1 lg:row-start-1 lg:row-span-5 space-y-5 sm:space-y-6">
                      <div className="flex items-center justify-between">
                        ...
                        {details.biometric_diagnostics.overall_capture_quality >= 75 ? (
                          <span className="flex items-center gap-1.5 text-[0.65rem] sm:text-xs font-medium text-emerald-400 bg-emerald-500/10 px-2.5 py-1 rounded-full border border-emerald-500/20">
                          ...
                          <span className="flex items-center gap-1.5 text-[0.65rem] sm:text-xs font-medium text-amber-400 bg-amber-500/10 px-2.5 py-1 rounded-full border border-amber-500/20">
                            <span className="h-1.5 w-1.5 rounded-full bg-amber-400"></span> Acceptable
                          </span>
                        ) : (
                          <span className="flex items-center gap-1.5 text-[0.65rem] sm:text-xs font-medium text-rose-400 bg-rose-500/10 px-2.5 py-1 rounded-full border border-rose-500/20">
                      ...
                      <div className="relative pl-5 space-y-6 before:absolute before:inset-y-2 before:left-[9px] before:w-px before:bg-white/[0.08]">
                        {details.timeline.map((log, i) => (
                          <div key={log.id} className="relative">
                            <div className={`absolute -left-7 h-3 w-3 rounded-full border-2 border-[#03060c] ${i === 0 ? 'bg-cyan-500 shadow-[0_0_10px_rgba(34,211,238,0.5)]' : 'bg-slate-700'}`} />
              ...
              <div className="absolute bottom-0 inset-x-0 border-t border-white/[0.04] bg-[#03060c]/90 backdrop-blur-xl p-4 sm:p-6 pb-[calc(1rem+env(safe-area-inset-bottom))] sm:pb-[calc(1.5rem+env(safe-area-inset-bottom))] z-20">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <div className="flex flex-row items-center gap-3 sm:gap-4 w-full lg:w-auto">
                    ...
                    <button
                      ...
                      className="group relative flex-[2] lg:flex-none min-h-[50px] overflow-hidden rounded-2xl bg-cyan-500 px-4 sm:px-6 text-[0.85rem] sm:text-sm font-medium text-black hover:bg-cyan-400 disabled:opacity-50 transition-all shadow-[0_0_20px_rgba(34,211,238,0.15)] hover:shadow-[0_0_30px_rgba(34,211,238,0.3)] disabled:shadow-none active:scale-[0.98]"
                    >
